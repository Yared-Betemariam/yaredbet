...
const HeroSection = () => {
  return (
    <section className="wrapper flex flex-col gap-12 md:gap-20 md:flex-row pt-10 sm:pt-12 md:items-center">
      <div className="flex flex-col py-14 gap-6 md:gap-6 lg:flex-1">
        ...
        <div className="flex items-center">
          <h1 className="text-[3.5rem] leading-10 md:text-6xl lg:text-7xl font-bold drop-shadow-md">
            Yared Betemariam
          </h1>
